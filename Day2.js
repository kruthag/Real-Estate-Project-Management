...
//                         <p className="text-violet-700 hover:text-violet-800 text-3xl font-bold transition">Acres</p>
//                     </Link>
...
const Header = () => {
    const { user, logout } = useContext(UserContext); // Access user state and logout function from context
                ...
                <div className="flex items-center gap-6">
                    {user ? (
                        <div className="flex items-center gap-3">
                            ...
                            <p>{user.email}</p>
                            <button onClick={logout} className="border-2 text-violet-800 px-4 py-3 rounded-lg hover:bg-violet-300 hover:text-white transition">
                                Log out
                            </button>
                        </div>
                    ) : (
